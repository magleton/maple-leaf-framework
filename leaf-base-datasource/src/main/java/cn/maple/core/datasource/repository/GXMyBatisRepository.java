...
public abstract class GXMyBatisRepository<M extends GXBaseMapper<T, R>, T extends GXBaseModel, D extends GXMyBatisDao<M, T, R, ID>, R extends GXBaseResDto, ID> implements GXBaseRepository<T, R, ID> {
    /**
     * 基础DAO
     */
