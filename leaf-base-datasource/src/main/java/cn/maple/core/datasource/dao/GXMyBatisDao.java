...
public class GXMyBatisDao<M extends GXBaseMapper<T, R>, T extends GXMyBatisModel, R extends GXBaseResDto, ID> extends ServiceImpl<M, T> implements GXBaseDao<T, R, ID> {
    /**
     * 日志对象
     */
