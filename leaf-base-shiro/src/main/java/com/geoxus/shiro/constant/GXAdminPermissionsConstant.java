...
public class GXAdminPermissionsConstant {
    ...
    public static final String TABLE_NAME = "admin_permissions";
    ...
    public static final int CORE_MODEL_ID = GXFrameworkCommonUtils.getEnvironmentValue("app.com.geoxus.core-model-id.admin_permissions", Integer.class, 100);
