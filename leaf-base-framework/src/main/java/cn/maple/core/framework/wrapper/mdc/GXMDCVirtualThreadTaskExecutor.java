...
/**
 * GXMDCVirtualThreadTaskExecutor
 * 虚拟线程包装类
 *
 * <p>
 * 解决场景:
 ...
 * <p>
 * 使用方法:
 * 在需要使用线程池的时候, 使用GXMDCVirtualThreadTaskExecutor类创建线程池去执行相关逻辑
 *
 * @author britton@126.com
 */
public class GXMDCVirtualThreadTaskExecutor extends TaskExecutorAdapter {
    public GXMDCVirtualThreadTaskExecutor() {
        super(Executors.newThreadPerTaskExecutor(Thread.ofVirtual().name("virtual-mapleaf#", 1).factory()));
    }

    public GXMDCVirtualThreadTaskExecutor(Executor concurrentExecutor) {
