...
@Data
public class GXTokenInvalidException extends RuntimeException {
    @Serial
    ...
    public GXTokenInvalidException(String msg, int code, Dict data, Throwable e) {
        super(msg, e);
        this.msg = msg;
        this.code = code;
        this.data = data;
    ...
    public GXTokenInvalidException(String msg, int code, Dict data) {
    ...
    public GXTokenInvalidException(GXResultStatusCode resultCode) {
        this(resultCode, "");
    }

    public GXTokenInvalidException(GXResultStatusCode resultCode, @NotNull String msg) {
        this(resultCode, msg, Dict.create());
    }

    public GXTokenInvalidException(GXResultStatusCode resultCode, Throwable e) {
        this(resultCode, e, Dict.create());
    }

    public GXTokenInvalidException(GXResultStatusCode resultCode, @NotNull String msg, @NotNull Dict data) {
        this(resultCode, msg, data, null);
    }

    public GXTokenInvalidException(GXResultStatusCode resultCode, Throwable e, @NotNull Dict data) {
        this(resultCode, "", data, e);
    }

    public GXTokenInvalidException(GXResultStatusCode resultCode, @NotNull String msg, @NotNull Dict data, Throwable e) {
