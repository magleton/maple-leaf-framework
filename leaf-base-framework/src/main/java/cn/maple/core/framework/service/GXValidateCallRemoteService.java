 ...
 * 调用指定服务进行验证
 */
public interface GXValidateCallRemoteService {
    /**
     ...
     */
    boolean validateCallRemoteService(Object value, ConstraintValidatorContext constraintValidatorContext, Dict param) throws UnsupportedOperationException;
}
