package com.geoxus.core.framework.aspect;
...
public class GXStopWatchAspect {
    @Pointcut("@annotation(com.geoxus.core.framework.annotation.GXStopWatch) || @within(com.geoxus.core.framework.annotation.GXStopWatch)")
