...
import static cn.maple.statemachine.GXStateMachinePlantUMLTest.PriceAdjustmentTaskEventEnum.*;
import static cn.maple.statemachine.GXStateMachinePlantUMLTest.PriceAdjustmentTaskStatusEnum.*;

/**
 * GXStateMachinePlantUMLTest
 */
public class GXStateMachinePlantUMLTest {
    @Before
    public void init() {
    ...
    public void testPlantUML() {
        GXStateMachineBuilder<PriceAdjustmentTaskStatusEnum, PriceAdjustmentTaskEventEnum, GXStateMachineTest.Context> builder = GXStateMachineBuilderFactory.create();
        ...
        GXStateMachine<PriceAdjustmentTaskStatusEnum, PriceAdjustmentTaskEventEnum, GXStateMachineTest.Context> stateMachine = builder.build("AdjustPriceTask");
    ...
    private GXAction<PriceAdjustmentTaskStatusEnum, PriceAdjustmentTaskEventEnum, GXStateMachineTest.Context> doAction() {
        GXDebugger.enableDebug();
